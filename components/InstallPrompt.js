  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, fontSize: 13.5 }}>
        ...
        <div style={{ color: '#D1D5DB' }}>Add it to your home screen for quick access.</div>
      </div>
      <button onClick={install} style={{ background: '#2563EB', color: '#fff', border: 'none', borderRadius: 8, padding: '8px 14px', fontWeight: 700, fontSize: 13, cursor: 'pointer', whiteSpace: 'nowrap' }}>
        Install
      </button>
